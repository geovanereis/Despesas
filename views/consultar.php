...
$query_consult = "select * from despesas where enviado = 'f' order by 1 desc";//"select * from despesas where solicitante = '$user_session'";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="botao-test">
                            ...
                            <div>
                                <a href="enviar?id=<?php echo $row['id']; ?>" onclick="if (confirm('Deseja enviar para aprovação? Apos confirmado não é possivel desfazer o envio!')) location='comandos/aprovacao.php?id=<?php echo $row['id']; ?>';return false" class="btn btn-warning">
                                    <i class="bi bi-send"></i><!--delete-->
                                </a>
                            </div>
                        </td>
